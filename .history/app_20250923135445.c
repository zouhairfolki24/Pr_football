...
void remplissage_donnees_joueurs() {
    ...
    struct Joueur joueur1 = {1, "messi", "lionel", "attaquant", 10, 37, 91};
    struct Joueur joueur1 = {2, "ronaldo", "crestiano", "attaquant", 10, 37, 91};
    struct Joueur joueur1 = {3, "messi", "lionel", "attaquant", 10, 37, 91};
