            ...
            while (true) {
                ...
                if (strcmp(choix_statistiques, "1") == 0) {
                    ...
                    if (pos_buteur != -1) {
                        ...
                        printf("\nID: %d, Nom: %s, Prenom: %s, Numero Maillot: %d, Poste: %s, Age: %d, Buts: %d.\n", equipe[pos_buteur].id, equipe[pos_buteur].nom, equipe[i].prenom, equipe[i].numeroMaillot, equipe[pos_buteur].poste, equipe[pos_buteur].age, equipe[pos_buteur].buts);
                    }
