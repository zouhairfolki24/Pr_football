...
void remplissage_donnees_joueurs() {
    ...
    struct Joueur joueur1 = {3, "lamine", "yamal", "attaquant", 19, 18, 12};
    struct Joueur joueur1 = {4, "palmer", "cole", "milieu", 24, 23, 19};
    struct Joueur joueur1 = {5, "van dijk", "virgil", "defenseur", 4, 34, 4};
    struct Joueur joueur1 = {6, "raphinha", "dias", "attaquant", 11, 28, 21};
    struct Joueur joueur1 = {7, "pedri", "gonzalez", "milieu", 8, 22, 7};
    struct Joueur joueur1 = {8, "garcia", "joan", "gardien", 13, 24, 0};
    struct Joueur joueur1 = {9, "dias", "ruben", "defenseur", 3, 28, 1};
    struct Joueur joueur1 = {10, "salah", "mohamed", "attaquant", 14, 28, 16};
