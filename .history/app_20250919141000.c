...
int recherche_par_nom(int size_joueurs) {
    ...
    for (int i = 0; i < size_joueurs; i++) {
        if (strcmp(equipe[i].nom, new_nom) == 0 && strcmp(equipe[i].nom, "") != 0) {
            return i;
        }
    }
...
int position_meilleur_buteur(int size_joueurs) {

    int pos_buteur = 0, buteur_exist = 0;
    for (int i = 1; i < size_joueurs; i++) {
        if (equipe[i].buts > equipe[pos_buteur].buts && equipe[i].id != 0) {
            pos_buteur = i;
            buteur_exist = 1;
        }
    }
    ...
    while (true) {
        ...
        if (strcmp(choix, "1") == 0) {
            ...
            while (true) {
                ...
                if (strcmp(choix_statistiques, "1") == 0) {
                ...
                } else if (strcmp(choix_statistiques, "2") == 0) {
                    ...
                    if (pos_buteur != -1) {
                        ...
                        printf("\nID: %d, Nom: %s, Prenom: %s, Numero Maillot: %d, Poste: %s, Age: %d, Buts: %d.\n", equipe[pos_buteur].id, equipe[pos_buteur].nom, equipe[i].prenom, equipe[pos_buteur].numeroMaillot, equipe[pos_buteur].poste, equipe[pos_buteur].age, equipe[pos_buteur].buts);
                    }
