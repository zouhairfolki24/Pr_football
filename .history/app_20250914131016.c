...
int main() {
    ...
    printf("\nNom: %s, Prenom: %s, Numero Maillot: %d, Poste: %s, Age: %d, Buts: %d.\n", equipe[1].nom, equipe[1].prenom, equipe[1].numeroMaillot, equipe[1].poste, equipe[1].age, equipe[1].buts);
    
    // printf("\nNom: %s, Prenom: %s, Numero Maillot: %d, Poste: %s, Age: %d, Buts: %d.\n", joueur.nom, joueur.prenom, joueur.numeroMaillot, joueur.poste, joueur.age, joueur.buts);
    return 0;
}