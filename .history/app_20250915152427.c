...
void affiche_joueurs_trier_nom(int size_joueurs) {
    ...
    for (int i = 0; i < size_joueurs; i++) {
        if (equipe[i].id != 0) {
            printf("\n(index : %d) ID: %d, Nom: %s, Prenom: %s, Numero Maillot: %d, Poste: %s, Age: %d, Buts: %d.\n", i, equipe[i].id, equipe[i].nom, equipe[i].prenom, equipe[i].numeroMaillot, equipe[i].poste, equipe[i].age, equipe[i].buts);
        // }
    }
        ...
        if (strcmp(choix, "1") == 0) {
            ...
            while (true) {
                ...
                if (strcmp(choix_affiche, "1") == 0) {
                    ...
                    affiche_joueurs_trier_nom(size_joueurs);
