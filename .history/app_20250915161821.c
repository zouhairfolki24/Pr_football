...
void afficher_postes(int size_joueurs, struct Joueur joueurs[]) {
...
void afficher_joueurs_par_poste(int size_joueurs) {
    ...
    struct Joueur gardiens[100] = {0}, defenseurs[100] = {0}, milieux[100], attaquants[100];
    int j = 0;
    for (int i = 0; i < size_joueurs; i++) {
    ...
    afficher_postes(size_joueurs, gardiens);
    afficher_postes(size_joueurs, defenseurs);
    afficher_postes(size_joueurs, milieux);
    afficher_postes(size_joueurs, attaquants);
